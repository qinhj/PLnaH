...
public class OrganizationDictionary
{
     ...
     * 机构名词典
     */
    public static NTDictionary dictionary = null;
    /**
     * 转移矩阵词典
     */
    public static TransformMatrixDictionary<NT> transformMatrixDictionary = null;
    /**
     * AC算法用到的Trie树
     */
    ...
    static {
        if (null == dictionary) {
            initOrganizationDictionary();
        }
    }

    private static synchronized void initOrganizationDictionary() {
        if (null == dictionary) {
